...
from model import soilIDModel_v3, soilIDModel_US_v3
...
class soilIDList(Resource):
    def get(self):
        ...
        if pointer is None:
            ...
            data = soilIDModel_US_v3.getSoilLocationBasedUS(args.longitude, args.latitude, args.plot_id)
        elif pointer == 'Global':
            data = soilIDModel_v3.getSoilLocationBasedGlobal(args.longitude, args.latitude, args.plot_id)
        return data
    def put(self):
        return {'put': 'Put'}
...
class soilIDRank(Resource):
    def get(self):
        ...
        if pointer is None:
            ...
            data = soilIDModel_US_v3.rankPredictionUS(args.longitude, args.latitude, userTextureByDepth, userHorizonDepth, userRFVDepth, lab_Color, args.slope, args.elevation, args.bedrock, args.cracks, args.plot_id)
        elif pointer == 'Global':
            data = soilIDModel_v3.rankPredictionGlobal(args.longitude, args.latitude, userTextureByDepth, userHorizonDepth, userRFVDepth, lab_Color, args.bedrock, args.cracks, args.plot_id)
        return data
    def put(self):
        return {'put': 'Put'}
